...
async def get_prompt_info(
    ...
    if prompt_spec is None:
        latest_prompt_id = get_latest_version_prompt_id(
            prompt_id=prompt_id, all_prompt_ids=IN_MEMORY_PROMPT_REGISTRY.IN_MEMORY_PROMPTS
        )
...
async def delete_prompt(
    ...
    try:
        ...
        await prisma_client.db.litellm_prompttable.delete(where={"prompt_id": prompt_id})
...
async def patch_prompt(
    ...
    try:
        ...
        updated_prompt_info = (
            request.prompt_info if request.prompt_info is not None else existing_prompt.prompt_info
        )
...
async def test_prompt(
    ...
    try:
        ...
        rendered_content = prompt_manager.jinja_env.from_string(template_content).render(
            **variables
        )

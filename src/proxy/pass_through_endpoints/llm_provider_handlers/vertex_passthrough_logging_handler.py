...
class VertexPassthroughLoggingHandler:
        ...
        **kwargs,
        ...
        if "predictLongRunning" in url_route:
            ...
            vertex_publisher_or_api_spec = (
                VertexPassthroughLoggingHandler._get_vertex_publisher_or_api_spec_from_url(
                    url_route
                )
            )
    ...
    def _handle_predict_response(
        ...
        litellm_prediction_response: Union[ModelResponse, EmbeddingResponse, ImageResponse] = (
            ModelResponse()
        )
        ...
        **kwargs,
        ...
        try:
            ...
            if httpx_response.status_code == 200 and "name" in _json_response:
                ...
                actual_model_id = VertexPassthroughLoggingHandler.get_actual_model_id_from_router(
                    model_name
                )
    ...
    def get_actual_model_id_from_router(model_name: str) -> str:
        ...
        if llm_router is not None:
            ...
            extracted_model_name = (
                VertexPassthroughLoggingHandler.extract_model_name_from_vertex_path(model_name)
            )

...
class VertexAIGeminiImageGenerationConfig(BaseImageGenerationConfig, VertexLLM):
    ...
    def get_complete_url(
        ...
        vertex_project = (
            self.safe_get_vertex_ai_project(litellm_params) or self._resolve_vertex_project()
        )
        vertex_location = (
            self.safe_get_vertex_ai_location(litellm_params) or self._resolve_vertex_location()
        )
    ...
    def transform_image_generation_request(
        ...
        request_body: Dict[str, Any] = {"contents": contents, "generationConfig": generation_config}

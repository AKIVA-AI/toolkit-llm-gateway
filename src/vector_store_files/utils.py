...
class VectorStoreFileRequestUtils:
    ...
    def _filter_params(params: Dict[str, Any], model: Any) -> Dict[str, Any]:
        ...
        return {
            key: value for key, value in params.items() if key in valid_keys and value is not None
        }

    @staticmethod
    def get_create_request_params(params: Dict[str, Any]) -> VectorStoreFileCreateRequest:
    ...
    @staticmethod
    def get_update_request_params(params: Dict[str, Any]) -> VectorStoreFileUpdateRequest:
        filtered = VectorStoreFileRequestUtils._filter_params(

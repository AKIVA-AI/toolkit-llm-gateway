...
class DBSpendUpdateWriter:
    ...
    async def _update_key_db(
        ...
        try:
            ...
            verbose_proxy_logger.exception(f"Update Key DB Call failed to execute - {str(e)}")
            raise e
    ...
    async def _commit_spend_updates_to_db_with_redis(
        ...
        if await self.pod_lock_manager.acquire_lock(
            ...
            try:
                ...
                daily_team_spend_update_transactions = await self.redis_update_buffer.get_all_daily_team_spend_update_transactions_from_redis_buffer()
                ...
                daily_org_spend_update_transactions = await self.redis_update_buffer.get_all_daily_org_spend_update_transactions_from_redis_buffer()
                ...
                daily_end_user_spend_update_transactions = await self.redis_update_buffer.get_all_daily_end_user_spend_update_transactions_from_redis_buffer()
                ...
                daily_agent_spend_update_transactions = await self.redis_update_buffer.get_all_daily_agent_spend_update_transactions_from_redis_buffer()
    ...
    async def _commit_spend_updates_to_db(  # noqa: PLR0915
        ...
        verbose_proxy_logger.debug(
            "Team Membership Spend transactions: {}".format(team_member_list_transactions)
        )
        if (

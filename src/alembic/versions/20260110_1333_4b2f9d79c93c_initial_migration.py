...
def upgrade() -> None:
    ...
    op.create_index('idx_aggregates_unique', 'cost_aggregates', ['dimension_type', 'dimension_id', 'period_type', 'period_start'], unique=True)
    op.create_index(op.f('ix_cost_aggregates_dimension_id'), 'cost_aggregates', ['dimension_id'], unique=False)
    op.create_index(op.f('ix_cost_aggregates_dimension_type'), 'cost_aggregates', ['dimension_type'], unique=False)
    op.create_index(op.f('ix_cost_aggregates_period_start'), 'cost_aggregates', ['period_start'], unique=False)
    op.create_index(op.f('ix_cost_aggregates_period_type'), 'cost_aggregates', ['period_type'], unique=False)
    op.create_index(op.f('ix_cost_aggregates_total_cost'), 'cost_aggregates', ['total_cost'], unique=False)
    ...
    op.create_index(op.f('ix_llm_requests_total_cost'), 'llm_requests', ['total_cost'], unique=False)
    ...
    sa.Column('notification_channels', toolkit_extensions.database.models.JSONType(), nullable=True),
    sa.Column('extra_metadata', toolkit_extensions.database.models.JSONType(), nullable=True),
    ...
    op.create_index(op.f('ix_budget_alerts_notified_at'), 'budget_alerts', ['notified_at'], unique=False)

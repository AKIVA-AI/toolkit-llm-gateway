...
def exception_type(  # type: ignore  # noqa: PLR0915
    ...
    if any(
        isinstance(original_exception, exc_type) for exc_type in litellm.LITELLM_EXCEPTION_TYPES
    ):
    ...
    try:
        ...
        if model:
            ...
            if (
                ...
                custom_llm_provider == "anthropic" or custom_llm_provider == "anthropic_text"
                ...
                elif ExceptionCheckers.is_azure_content_policy_violation_error(error_str):
                    exception_mapping_worked = True
